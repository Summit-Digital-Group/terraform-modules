...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_this_container_def"></a> [this\_container\_def](#module\_this\_container\_def) | cloudposse/ecs-container-definition/aws | 0.56.0 |
...
| <a name="input_awslogs_group"></a> [awslogs\_group](#input\_awslogs\_group) | The name of the logs group to send log event to. | `any` | n/a | yes |
| <a name="input_awslogs_prefix"></a> [awslogs\_prefix](#input\_awslogs\_prefix) | The prefix to use when sending log events to the logs group. | `any` | n/a | yes |
